...
import { ShoppingCart, Heart, Share2, Truck, Shield, RotateCcw, Loader2, CreditCard } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div className="border-t pt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div><p className="font-medium">2 Year Warranty</p></div>
              </div>
              <div className="flex items-center gap-3">
                <RotateCcw className="h-5 w-5 text-primary" />
                <div><p className="font-medium">30 Day Returns</p></div>
              </div>
            </div>
          </div>
        </div>
